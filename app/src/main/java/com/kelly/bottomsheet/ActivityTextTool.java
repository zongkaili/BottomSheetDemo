 ...
 * @desc:
 */
public class ActivityTextTool extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTvAboutSpannable = findViewById(R.id.tvTest);
        initView();
    }
    ...
    private void initView() {
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View widget) {
                Toast.makeText(ActivityTextTool.this, "事件触发了", Toast.LENGTH_SHORT).show();
            }
        ...
        TextSpanTool.getBuilder(this,"").setBold().setAlign(Layout.Alignment.ALIGN_CENTER)
                .append("测试").append("Url\n").setUrl("http://www.baidu.com")
                .append("列表项\n").setBullet(60, getResources().getColor(R.color.colorAccent))
                .append("  测试引用\n").setQuoteColor(getResources().getColor(R.color.colorPrimary))
